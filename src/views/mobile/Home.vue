<template>
  <div class="w-full">
    <div class="overflow-hidden rounded-b-[5px] mb-[5px]">
      <img src="../../assets/home.png" alt="home" class="w-full min-h-[100px]">
    </div>
    <div class="px-[5px]">
      <Tab :active-tab="activeTab" @changeTab="handleChangeTab" class="mb-[5px]" />
...
<script>
import Accordion from '../../components/mobile/Accordion.vue';
